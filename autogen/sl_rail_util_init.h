...
#include "rail.h"
#include "sl_rail_util_init_rail_handle_inst_config.h"
...
typedef enum sl_rail_util_handle_type{
  SL_RAIL_UTIL_HANDLE_RAIL_HANDLE_INST,
 ...
 * run-time.
 */
#define SL_RAIL_UTIL_INIT_EVENT_RAIL_HANDLE_INST_MASK (RAIL_EVENTS_NONE              \
  | (SL_RAIL_UTIL_INIT_EVENT_RSSI_AVERAGE_DONE_RAIL_HANDLE_INST_ENABLE               \
    ? RAIL_EVENT_RSSI_AVERAGE_DONE : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_ACK_TIMEOUT_RAIL_HANDLE_INST_ENABLE                  \
    ? RAIL_EVENT_RX_ACK_TIMEOUT : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FIFO_ALMOST_FULL_RAIL_HANDLE_INST_ENABLE             \
    ? RAIL_EVENT_RX_FIFO_ALMOST_FULL : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PACKET_RECEIVED_RAIL_HANDLE_INST_ENABLE              \
    ? RAIL_EVENT_RX_PACKET_RECEIVED : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PREAMBLE_LOST_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_RX_PREAMBLE_LOST : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PREAMBLE_DETECT_RAIL_HANDLE_INST_ENABLE              \
    ? RAIL_EVENT_RX_PREAMBLE_DETECT : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SYNC1_DETECT_RAIL_HANDLE_INST_ENABLE                 \
    ? RAIL_EVENT_RX_SYNC1_DETECT : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SYNC2_DETECT_RAIL_HANDLE_INST_ENABLE                 \
    ? RAIL_EVENT_RX_SYNC2_DETECT : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FRAME_ERROR_RAIL_HANDLE_INST_ENABLE                  \
    ? RAIL_EVENT_RX_FRAME_ERROR : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FIFO_FULL_RAIL_HANDLE_INST_ENABLE                    \
    ? RAIL_EVENT_RX_FIFO_FULL : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FIFO_OVERFLOW_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_RX_FIFO_OVERFLOW : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_ADDRESS_FILTERED_RAIL_HANDLE_INST_ENABLE             \
    ? RAIL_EVENT_RX_ADDRESS_FILTERED : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TIMEOUT_RAIL_HANDLE_INST_ENABLE                      \
    ? RAIL_EVENT_RX_TIMEOUT : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TX_SCHEDULED_RX_TX_STARTED_RAIL_HANDLE_INST_ENABLE   \
    ? RAIL_EVENT_SCHEDULED_RX_STARTED : RAIL_EVENTS_NONE)                              \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SCHEDULED_RX_END_RAIL_HANDLE_INST_ENABLE             \
    ? RAIL_EVENT_RX_SCHEDULED_RX_END : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SCHEDULED_RX_MISSED_RAIL_HANDLE_INST_ENABLE          \
    ? RAIL_EVENT_RX_SCHEDULED_RX_MISSED : RAIL_EVENTS_NONE)                            \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PACKET_ABORTED_RAIL_HANDLE_INST_ENABLE               \
    ? RAIL_EVENT_RX_PACKET_ABORTED : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FILTER_PASSED_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_RX_FILTER_PASSED : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TIMING_LOST_RAIL_HANDLE_INST_ENABLE                  \
    ? RAIL_EVENT_RX_TIMING_LOST : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TIMING_DETECT_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_RX_TIMING_DETECT : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_CHANNEL_HOPPING_COMPLETE_RAIL_HANDLE_INST_ENABLE     \
    ? RAIL_EVENT_RX_CHANNEL_HOPPING_COMPLETE : RAIL_EVENTS_NONE)                       \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_DUTY_CYCLE_RX_END_RAIL_HANDLE_INST_ENABLE            \
    ? RAIL_EVENT_RX_DUTY_CYCLE_RX_END : RAIL_EVENTS_NONE)                              \
  | (SL_RAIL_UTIL_INIT_EVENT_IEEE802154_DATA_REQUEST_COMMAND_RAIL_HANDLE_INST_ENABLE \
    ? RAIL_EVENT_IEEE802154_DATA_REQUEST_COMMAND : RAIL_EVENTS_NONE)                   \
  | (SL_RAIL_UTIL_INIT_EVENT_ZWAVE_BEAM_RAIL_HANDLE_INST_ENABLE                      \
    ? RAIL_EVENT_ZWAVE_BEAM : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_ZWAVE_LR_ACK_REQUEST_COMMAND_RAIL_HANDLE_INST_ENABLE    \
    ? RAIL_EVENT_ZWAVE_LR_ACK_REQUEST_COMMAND : RAIL_EVENTS_NONE)                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_FIFO_ALMOST_EMPTY_RAIL_HANDLE_INST_ENABLE            \
    ? RAIL_EVENT_TX_FIFO_ALMOST_EMPTY : RAIL_EVENTS_NONE)                              \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_PACKET_SENT_RAIL_HANDLE_INST_ENABLE                  \
    ? RAIL_EVENT_TX_PACKET_SENT : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_PACKET_SENT_RAIL_HANDLE_INST_ENABLE               \
    ? RAIL_EVENT_TXACK_PACKET_SENT : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_ABORTED_RAIL_HANDLE_INST_ENABLE                      \
    ? RAIL_EVENT_TX_ABORTED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_ABORTED_RAIL_HANDLE_INST_ENABLE                   \
    ? RAIL_EVENT_TXACK_ABORTED : RAIL_EVENTS_NONE)                                     \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_BLOCKED_RAIL_HANDLE_INST_ENABLE                      \
    ? RAIL_EVENT_TX_BLOCKED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_BLOCKED_RAIL_HANDLE_INST_ENABLE                   \
    ? RAIL_EVENT_TXACK_BLOCKED : RAIL_EVENTS_NONE)                                     \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_UNDERFLOW_RAIL_HANDLE_INST_ENABLE                    \
    ? RAIL_EVENT_TX_UNDERFLOW : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_UNDERFLOW_RAIL_HANDLE_INST_ENABLE                 \
    ? RAIL_EVENT_TXACK_UNDERFLOW : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CHANNEL_CLEAR_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_TX_CHANNEL_CLEAR  : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CHANNEL_BUSY_RAIL_HANDLE_INST_ENABLE                 \
    ? RAIL_EVENT_TX_CHANNEL_BUSY : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CCA_RETRY_RAIL_HANDLE_INST_ENABLE                    \
    ? RAIL_EVENT_TX_CCA_RETRY : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_START_CCA_RAIL_HANDLE_INST_ENABLE                    \
    ? RAIL_EVENT_TX_START_CCA : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_STARTED_RAIL_HANDLE_INST_ENABLE                      \
    ? RAIL_EVENT_TX_STARTED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_SCHEDULED_TX_MISSED_RAIL_HANDLE_INST_ENABLE          \
    ? RAIL_EVENT_TX_SCHEDULED_TX_MISSED : RAIL_EVENTS_NONE)                            \
  | (SL_RAIL_UTIL_INIT_EVENT_CONFIG_UNSCHEDULED_RAIL_HANDLE_INST_ENABLE              \
    ? RAIL_EVENT_CONFIG_UNSCHEDULED : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_CONFIG_SCHEDULED_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_CONFIG_SCHEDULED : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_SCHEDULER_STATUS_RAIL_HANDLE_INST_ENABLE                \
    ? RAIL_EVENT_SCHEDULER_STATUS : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_CAL_NEEDED_RAIL_HANDLE_INST_ENABLE                      \
    ? RAIL_EVENT_CAL_NEEDED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_DETECT_RSSI_THRESHOLD_RAIL_HANDLE_INST_ENABLE           \
    ? RAIL_EVENT_DETECT_RSSI_THRESHOLD : RAIL_EVENTS_NONE)                             \
  | (SL_RAIL_UTIL_INIT_EVENT_THERMISTOR_DONE_RAIL_HANDLE_INST_ENABLE                 \
    ? RAIL_EVENT_THERMISTOR_DONE : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_BLOCKED_TOO_HOT_RAIL_HANDLE_INST_ENABLE              \
    ? RAIL_EVENT_TX_BLOCKED_TOO_HOT : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_TEMPERATURE_TOO_HOT_RAIL_HANDLE_INST_ENABLE             \
    ? RAIL_EVENT_TEMPERATURE_TOO_HOT : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_TEMPERATURE_COOL_DOWN_RAIL_HANDLE_INST_ENABLE           \
 ...
 * run-time.
 */
#define SL_RAIL_UTIL_INIT_EVENT_RAIL_HANDLE_INST_INVERSE_MASK \
